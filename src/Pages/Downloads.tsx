        ...
        <Grid container>
          ...
          <Grid item sm={4} xs={12}>
            <Card>
              ...
              <Typo.P>
                Useful code snippets and utilities available to download for
                free, many of which are from my YouTube tutorials
              </Typo.P>
              <Typo.P>
                Downloads include mobile phone vibrator controllers, a basic
                Unity Ads manager and more utility scripts!
              </Typo.P>
              <Button
                href=""
          ...
          <Grid item sm={4} xs={12}>
            <Card>
              ...
              <Typo.P>
                Recently I created a new look... A new logo, social banners and
                so on, I also created myself a few wallpapers for my PCs and
                Mac. Last time I had a few requests for those wallpapers from
                people so here you go! Show your support by sporting our logo on
                your desktop!
              </Typo.P>
              ...
              <WallpaperThumb
                ...
                onClick={() =>
                  openWallpaper(
                    "Images/Wallpapers/Wallpapers_WhiteOnPurple.png"
                  )
                }
              />
              <br />
