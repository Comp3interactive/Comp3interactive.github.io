...
import { Footer, Card, Button, NavLinks, Header, InfoBar } from "../Components";
        ...
        <Grid item sm={7} xs={12}>
          <Card>
            ...
            <Typo.P>
              ...
              we wish we had ourselves when we started to learn game
              development.
            </Typo.P>
            <Typo.P>
            ...
            <Typo.P>
              Check out the links below to learn more about the services we
              offer and find links to where you can find us, or if you're in a
              hurry to get learning you can click here to be taken directly to
              our YouTube page! Just don't forget to like, comment and
              subscribe!
            </Typo.P>
        ...
        <Grid item sm={5} xs={12}>
          <Card>
            ...
            <Typo.P>
              ...
              most of the content on this website, so here you go, quick links
              to everywhere you can find me!
            </Typo.P>
