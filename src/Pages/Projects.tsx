        ...
        <Grid container>
          <Grid item md={8} xs={12}>
            <Card>
              ...
              <Typo.P>
                ...
                fulltime project. There is no estimated release date at the
                moment because I'm working around my day job and family life.
              </Typo.P>
          ...
          <Grid item md={4} xs={12}>
            <Card>
              ...
              <Typo.P>
                A simple infinate climber for Android. Tap the left side to
                jump, tap the right side to attack! How far can you climb?
              </Typo.P>
